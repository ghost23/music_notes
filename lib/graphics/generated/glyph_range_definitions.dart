...
class GlyphRangeData {
  const GlyphRangeData(this.description, this.rangeStart, this.rangeEnd, this.glyphs);
...
const glyphRangeMap = <GlyphRange, GlyphRangeData>{
  ...
  GlyphRange.arelEzgiUzdilekAeuAccidentals: GlyphRangeData("Arel-Ezgi-Uzdilek (AEU) accidentals", "U+E440", "U+E44F", [
  ...
  GlyphRange.arrowsAndArrowheads: GlyphRangeData("Arrows and arrowheads", "U+EB60", "U+EB8F", [
    Glyph.arrowBlackUp,
  ...
  GlyphRange.athenianSagittalExtensionMediumPrecisionAccidentals:
      GlyphRangeData("Athenian Sagittal extension (medium precision) accidentals", "U+E340", "U+E36F", [
  ...
  GlyphRange.barRepeats:
      GlyphRangeData("Bar repeats", "U+E500", "U+E50F", [Glyph.repeat1Bar, Glyph.repeat2Bars, Glyph.repeat4Bars]),
  ...
  GlyphRange.beamedGroupsOfNotes: GlyphRangeData("Beamed groups of notes", "U+E1F0", "U+E20F", [
  ...
  GlyphRange.beamsAndSlurs: GlyphRangeData("Beams and slurs", "U+E8E0", "U+E8EF", [
  ...
  GlyphRange.beatersPictograms: GlyphRangeData("Beaters pictograms", "U+E770", "U+E7EF", [
  ...
  GlyphRange.bellsPictograms: GlyphRangeData("Bells pictograms", "U+E710", "U+E71F", [
  ...
  GlyphRange.brassTechniques: GlyphRangeData("Brass techniques", "U+E5D0", "U+E5EF", [
    Glyph.brassScoop,
  ...
  GlyphRange.chimesPictograms: GlyphRangeData("Chimes pictograms", "U+E6C0", "U+E6CF", [
  ...
  GlyphRange.chordDiagrams: GlyphRangeData("Chord diagrams", "U+E850", "U+E85F", [
  ...
  GlyphRange.combiningStaffPositions: GlyphRangeData("Combining staff positions", "U+EB90", "U+EB9F", [
  ...
  GlyphRange.combiningStrokesForTrillsAndMordents:
      GlyphRangeData("Combining strokes for trills and mordents", "U+E590", "U+E5AF", [
  ...
  GlyphRange.commonOrnaments: GlyphRangeData("Common ornaments", "U+E560", "U+E56F", [
  ...
  GlyphRange.conductorSymbols: GlyphRangeData("Conductor symbols", "U+E890", "U+E89F", [
  ...
  GlyphRange.cymbalsPictograms: GlyphRangeData("Cymbals pictograms", "U+E720", "U+E72F", [
  ...
  GlyphRange.daseianNotation: GlyphRangeData("Daseian notation", "U+EA30", "U+EA4F", [
  ...
  GlyphRange.drumsPictograms: GlyphRangeData("Drums pictograms", "U+E6D0", "U+E6EF", [
    Glyph.pictTimpani,
    Glyph.pictSnareDrum,
  ...
  GlyphRange.electronicMusicPictograms: GlyphRangeData("Electronic music pictograms", "U+EB10", "U+EB5F", [
  ...
  GlyphRange.extendedHelmholtzEllisAccidentalsJustIntonation:
      GlyphRangeData("Extended Helmholtz-Ellis accidentals (just intonation)", "U+E2C0", "U+E2FF", [
  ...
  GlyphRange.extendedSteinZimmermannAccidentals:
      GlyphRangeData("Extended Stein-Zimmermann accidentals", "U+E290", "U+E29F", [
  ...
  GlyphRange.frenchAndEnglishRenaissanceLuteTablature:
      GlyphRangeData("French and English Renaissance lute tablature", "U+EBC0", "U+EBDF", [
  ...
  GlyphRange.functionTheorySymbols: GlyphRangeData("Function theory symbols", "U+EA70", "U+EA9F", [
    Glyph.functionZero,
    Glyph.functionOne,
    Glyph.functionTwo,
    Glyph.functionThree,
  ...
  GlyphRange.germanRenaissanceLuteTablature: GlyphRangeData("German Renaissance lute tablature", "U+EC00", "U+EC2F", [
  ...
  GlyphRange.gongsPictograms: GlyphRangeData("Gongs pictograms", "U+E730", "U+E73F", [
    Glyph.pictTamTam,
  ...
  GlyphRange.gouldArrowQuartertoneAccidentals24Edo:
      GlyphRangeData("Gould arrow quartertone accidentals (24-EDO)", "U+E270", "U+E27F", [
  ...
  GlyphRange.harpTechniques: GlyphRangeData("Harp techniques", "U+E680", "U+E69F", [
  ...
  GlyphRange.herculeanSagittalExtensionVeryHighPrecisionAccidentalDiacritics: GlyphRangeData(
      "Herculean Sagittal extension (very high precision) accidental diacritics",
      "U+E3F0",
      "U+E3FF",
      [Glyph.accSagittalShaftUp, Glyph.accSagittalShaftDown, Glyph.accSagittalAcute, Glyph.accSagittalGrave]),
  GlyphRange.holdsAndPauses: GlyphRangeData("Holds and pauses", "U+E4C0", "U+E4DF", [
    Glyph.fermataAbove,
    Glyph.fermataBelow,
  ...
  GlyphRange.individualNotes: GlyphRangeData("Individual notes", "U+E1D0", "U+E1EF", [
  ...
  GlyphRange.italianAndSpanishRenaissanceLuteTablature:
      GlyphRangeData("Italian and Spanish Renaissance lute tablature", "U+EBE0", "U+EBFF", [
  ...
  GlyphRange.johnstonAccidentalsJustIntonation:
      GlyphRangeData("Johnston accidentals (just intonation)", "U+E2B0", "U+E2BF", [
  ...
  GlyphRange.keyboardTechniques: GlyphRangeData("Keyboard techniques", "U+E650", "U+E67F", [
  ...
  GlyphRange.kievanSquareNotation: GlyphRangeData("Kievan square notation", "U+EC30", "U+EC3F", [
    Glyph.kievanCClef,
  ...
  GlyphRange.kodalyHandSigns: GlyphRangeData("Kodály hand signs", "U+EC40", "U+EC4F", [
    Glyph.kodalyHandDo,
    Glyph.kodalyHandRe,
    Glyph.kodalyHandMi,
    Glyph.kodalyHandFa,
  ...
  GlyphRange.magratheanSagittalExtensionInsanePrecisionAccidentalDiacritics:
      GlyphRangeData("Magrathean Sagittal extension (insane precision) accidental diacritics", "U+E410", "U+E41F", []),
  GlyphRange.medievalAndRenaissanceAccidentals:
      GlyphRangeData("Medieval and Renaissance accidentals", "U+E9E0", "U+E9EF", [
  ...
  GlyphRange.medievalAndRenaissanceClefs: GlyphRangeData("Medieval and Renaissance clefs", "U+E900", "U+E90F", [
    Glyph.mensuralGclef,
  ...
  GlyphRange.medievalAndRenaissanceIndividualNotes:
      GlyphRangeData("Medieval and Renaissance individual notes", "U+E950", "U+E96F", [
  ...
  GlyphRange.medievalAndRenaissanceMiscellany:
      GlyphRangeData("Medieval and Renaissance miscellany", "U+EA00", "U+EA1F", [
  ...
  GlyphRange.medievalAndRenaissanceNoteheadsAndStems:
      GlyphRangeData("Medieval and Renaissance noteheads and stems", "U+E930", "U+E94F", [
  ...
  GlyphRange.medievalAndRenaissanceObliqueForms:
      GlyphRangeData("Medieval and Renaissance oblique forms", "U+E970", "U+E98F", [
  ...
  GlyphRange.medievalAndRenaissancePlainchantArticulations:
      GlyphRangeData("Medieval and Renaissance plainchant articulations", "U+E9D0", "U+E9DF", [
  ...
  GlyphRange.medievalAndRenaissancePlainchantMultipleNoteForms:
      GlyphRangeData("Medieval and Renaissance plainchant multiple-note forms", "U+E9B0", "U+E9CF", [
  ...
  GlyphRange.medievalAndRenaissancePlainchantSingleNoteForms:
      GlyphRangeData("Medieval and Renaissance plainchant single-note forms", "U+E990", "U+E9AF", [
    Glyph.chantPunctum,
  ...
  GlyphRange.medievalAndRenaissanceProlations:
      GlyphRangeData("Medieval and Renaissance prolations", "U+E910", "U+E92F", [
  ...
  GlyphRange.medievalAndRenaissanceRests: GlyphRangeData("Medieval and Renaissance rests", "U+E9F0", "U+E9FF", [
  ...
  GlyphRange.medievalAndRenaissanceStaves: GlyphRangeData("Medieval and Renaissance staves", "U+E8F0", "U+E8FF", [
    Glyph.chantStaff,
  ...
  GlyphRange.medievalAndRenaissanceSymbolsInCmn:
      GlyphRangeData("Medieval and Renaissance symbols in CMN", "U+EA20", "U+EA2F", [
  ...
  GlyphRange.metallicStruckPercussionPictograms: GlyphRangeData(
      "Metallic struck percussion pictograms", "U+E700", "U+E70F", [Glyph.pictTriangle, Glyph.pictAnvil]),
  GlyphRange.metronomeMarks: GlyphRangeData("Metronome marks", "U+ECA0", "U+ECBF", [
  ...
  GlyphRange.miscellaneousPercussionInstrumentPictograms:
      GlyphRangeData("Miscellaneous percussion instrument pictograms", "U+E760", "U+E76F", [
  ...
  GlyphRange.miscellaneousSymbols: GlyphRangeData("Miscellaneous symbols", "U+EC60", "U+EC7F", [
  ...
  GlyphRange.multiSegmentLines: GlyphRangeData("Multi-segment lines", "U+EAA0", "U+EB0F", [
  ...
  GlyphRange.noteNameNoteheads: GlyphRangeData("Note name noteheads", "U+E150", "U+E1AF", [
    Glyph.noteDoWhole,
    Glyph.noteReWhole,
    Glyph.noteMiWhole,
    Glyph.noteFaWhole,
  ...
  GlyphRange.octavesSupplement: GlyphRangeData("Octaves supplement", "U+EC90", "U+EC9F", [
    Glyph.octaveLoco,
  ...
  GlyphRange.olympianSagittalExtensionExtremePrecisionAccidentalDiacritics:
      GlyphRangeData("Olympian Sagittal extension (extreme precision) accidental diacritics", "U+E400", "U+E40F", []),
  GlyphRange.otherAccidentals: GlyphRangeData("Other accidentals", "U+E470", "U+E49F", [
  ...
  GlyphRange.otherBaroqueOrnaments: GlyphRangeData("Other baroque ornaments", "U+E570", "U+E58F", [
  ...
  GlyphRange.percussionPlayingTechniquePictograms:
      GlyphRangeData("Percussion playing technique pictograms", "U+E7F0", "U+E80F", [
    Glyph.pictStickShot,
  ...
  GlyphRange.persianAccidentals:
      GlyphRangeData("Persian accidentals", "U+E460", "U+E46F", [Glyph.accidentalKoron, Glyph.accidentalSori]),
  GlyphRange.pluckedTechniques: GlyphRangeData("Plucked techniques", "U+E630", "U+E63F", [
  ...
  GlyphRange.precomposedTrillsAndMordents: GlyphRangeData("Precomposed trills and mordents", "U+E5B0", "U+E5CF", [
  ...
  GlyphRange.prometheanSagittalExtensionHighPrecisionMultiShaftAccidentals:
      GlyphRangeData("Promethean Sagittal extension (high precision) multi-shaft accidentals", "U+E3B0", "U+E3EF", [
  ...
  GlyphRange.prometheanSagittalExtensionHighPrecisionSingleShaftAccidentals:
      GlyphRangeData("Promethean Sagittal extension (high precision) single-shaft accidentals", "U+E390", "U+E3AF", [
  ...
  GlyphRange.renaissanceLuteTablature: GlyphRangeData("Renaissance lute tablature", "U+EBA0", "U+EBBF", [
  ...
  GlyphRange.roundAndSquareNoteheads: GlyphRangeData("Round and square noteheads", "U+E110", "U+E11F", [
  ...
  GlyphRange.shakersOrRattlesPictograms: GlyphRangeData("Shakers or rattles pictograms", "U+E740", "U+E74F", [
    Glyph.pictFlexatone,
    Glyph.pictMaraca,
    Glyph.pictMaracas,
    Glyph.pictCabasa,
  ...
  GlyphRange.shapeNoteNoteheads: GlyphRangeData("Shape note noteheads", "U+E1B0", "U+E1CF", [
  ...
  GlyphRange.simplifiedMusicNotation: GlyphRangeData("Simplified Music Notation", "U+EC50", "U+EC5F", [
    Glyph.smnSharp,
    Glyph.smnSharpWhite,
    Glyph.smnFlat,
    Glyph.smnFlatWhite,
  ...
  GlyphRange.simsAccidentals72Edo: GlyphRangeData("Sims accidentals (72-EDO)", "U+E2A0", "U+E2AF", [
  ...
  GlyphRange.slashNoteheads: GlyphRangeData("Slash noteheads", "U+E100", "U+E10F", [
  ...
  GlyphRange.spartanSagittalMultiShaftAccidentals:
      GlyphRangeData("Spartan Sagittal multi-shaft accidentals", "U+E310", "U+E33F", [
  ...
  GlyphRange.spartanSagittalSingleShaftAccidentals:
      GlyphRangeData("Spartan Sagittal single-shaft accidentals", "U+E300", "U+E30F", [
  ...
  GlyphRange.staffBracketsAndDividers: GlyphRangeData("Staff brackets and dividers", "U+E000", "U+E00F", [
    Glyph.brace,
    Glyph.reversedBrace,
    Glyph.bracket,
    Glyph.bracketTop,
  ...
  GlyphRange.standardAccidentals12Edo: GlyphRangeData("Standard accidentals (12-EDO)", "U+E260", "U+E26F", [
  ...
  GlyphRange.steinZimmermannAccidentals24Edo:
      GlyphRangeData("Stein-Zimmermann accidentals (24-EDO)", "U+E280", "U+E28F", [
  ...
  GlyphRange.stringTechniques: GlyphRangeData("String techniques", "U+E610", "U+E62F", [
  ...
  GlyphRange.timeSignatures: GlyphRangeData("Time signatures", "U+E080", "U+E09F", [
    Glyph.timeSig0,
    Glyph.timeSig1,
    Glyph.timeSig2,
    Glyph.timeSig3,
  ...
  GlyphRange.timeSignaturesSupplement: GlyphRangeData("Time signatures supplement", "U+EC80", "U+EC8F", [
  ...
  GlyphRange.trojanSagittalExtension12EdoRelativeAccidentals:
      GlyphRangeData("Trojan Sagittal extension (12-EDO relative) accidentals", "U+E370", "U+E38F", [
  ...
  GlyphRange.tunedMalletPercussionPictograms: GlyphRangeData("Tuned mallet percussion pictograms", "U+E6A0", "U+E6BF", [
    Glyph.pictGlsp,
    Glyph.pictXyl,
    Glyph.pictXylTenor,
    Glyph.pictXylBass,
  ...
  GlyphRange.turkishFolkMusicAccidentals: GlyphRangeData("Turkish folk music accidentals", "U+E450", "U+E45F", [
  ...
  GlyphRange.vocalTechniques: GlyphRangeData("Vocal techniques", "U+E640", "U+E64F", [
  ...
  GlyphRange.whistlesAndAerophonesPictograms: GlyphRangeData("Whistles and aerophones pictograms", "U+E750", "U+E75F", [
  ...
  GlyphRange.windTechniques: GlyphRangeData("Wind techniques", "U+E5F0", "U+E60F", [
  ...
  GlyphRange.woodenStruckOrScrapedPercussionPictograms:
      GlyphRangeData("Wooden struck or scraped percussion pictograms", "U+E6F0", "U+E6FF", [
    Glyph.pictWoodBlock,
  ...
  GlyphRange.wyschnegradskyAccidentals72Edo: GlyphRangeData("Wyschnegradsky accidentals (72-EDO)", "U+E420", "U+E43F", [
